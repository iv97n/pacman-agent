...
from heuristics import basic_attack_heursitic, distance_to_closest_food, distance_to_own_side, distance_to_enemy_in_own_side
from goals import GetFoodGoal, GoBackGoal, ChaseAgentGoal, PatrolGoal
...
def create_team(first_index, second_index, is_red,
    ...
    """
    first = 'BasicOffensiveAgent'
    second = 'BasicDefensiveAgent'
...
basic_setting = (basic_attack_heursitic, a_star)
...
class BasicOffensiveAgent(BasicAgent):
...
class BasicDefensiveAgent(BasicAgent):
